...
class GymViewController: UIViewController {
    ...
    @IBOutlet weak var submitGym: UIButton!
    override func viewDidLoad() {
        ...
        submitGym.layer.borderWidth = 4
        submitGym.layer.cornerRadius = 10.0
        submitGym.layer.cornerCurve = .continuous
    }
    ...
    func updateRatingOne() { // function used to update and store information relevant to the user's responses to question 1
        ...
        ratingOne.didFinishTouchingCosmos = {
            rate in
            DBHelper.inst.addGymReview(rating: rate)
